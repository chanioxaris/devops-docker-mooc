...
The Dockerfile is located [here](files/Part1/1.6/Dockerfile)
...
The Dockerfile is located [here](files/Part1/1.7/Dockerfile)

The script is located [here](files/Part1/1.7/script.sh)
...
The Dockerfile is located [here](files/Part1/1.10/Dockerfile)
...
The Dockerfile is located [here](files/Part1/1.11/Dockerfile)
...
The Dockerfile for frontend project is located [here](files/Part1/1.12/Dockerfile.frontend)

The Dockerfile for backend project is located [here](files/Part1/1.12/Dockerfile.backend)
...
The Dockerfile is located [here](files/Part1/1.13/Dockerfile)
...
The Dockerfile is located [here](files/Part1/1.15/Dockerfile)

We will use an example application build with `golang` which is located [here](files/Part1/1.15/golang-example-project)
